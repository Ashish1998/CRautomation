...
public class script2cr {
    ...
    public static void main(String[] args) throws MalformedURLException {
        ...
        WebElement option2 = driver.findElement(By.id("org.curiouslearning.container:id/text_input_end_icon"));
        option2.click();
        ...
        // Tapping
        Point centerOfElement = getCenterofElement(box.getLocation(), box.getSize(), 400);
        ...
        WebElement play = wait1.until(ExpectedConditions.elementToBeClickable(By.id("org.curiouslearning.container:id/web_app")));
        play.click();
